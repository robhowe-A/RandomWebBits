...
{
    internal sealed class virtualtourModel : PageModel
    {
        private readonly ILogger<virtualtourModel> _logger;
        private readonly Record _record;

        public virtualtourModel(ILogger<virtualtourModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
