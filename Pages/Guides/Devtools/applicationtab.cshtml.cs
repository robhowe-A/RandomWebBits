...
{
    internal sealed class applicationtabModel : PageModel
    {
        private readonly ILogger<applicationtabModel> _logger;
        private readonly Record _record;

        public applicationtabModel(ILogger<applicationtabModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
