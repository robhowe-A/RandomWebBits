...
{
    internal sealed class cssoverviewtabModel : PageModel
    {
        private readonly ILogger<cssoverviewtabModel> _logger;
        private readonly Record _record;

        public cssoverviewtabModel(ILogger<cssoverviewtabModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
