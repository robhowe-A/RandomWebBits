...
{
    internal sealed class networktabModel : PageModel
    {
        private readonly ILogger<networktabModel> _logger;
        private readonly Record _record;

        public networktabModel(ILogger<networktabModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
