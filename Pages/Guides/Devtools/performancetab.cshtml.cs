...
{
    internal sealed class performancetabModel : PageModel
    {
        private readonly ILogger<performancetabModel> _logger;
        private readonly Record _record;

        public performancetabModel(ILogger<performancetabModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
