...
{
    internal sealed class clearcookiesquicklyModel : PageModel
    {
        private readonly ILogger<clearcookiesquicklyModel> _logger;
        private readonly Record _record;

        public clearcookiesquicklyModel(ILogger<clearcookiesquicklyModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
