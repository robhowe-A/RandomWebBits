...
{
    internal sealed class inspectpagesModel : PageModel
    {
        private readonly ILogger<inspectpagesModel> _logger;
        private readonly Record _record;

        public inspectpagesModel(ILogger<inspectpagesModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
