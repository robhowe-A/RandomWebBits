...
{
    internal sealed class pwaiconModel : PageModel
    {
        private readonly ILogger<pwaiconModel> _logger;
        private readonly Record _record;

        public pwaiconModel(ILogger<pwaiconModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
