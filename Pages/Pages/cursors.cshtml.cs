...
{
    internal sealed class cursorsModel : PageModel
    {
        private readonly ILogger<cursorsModel> _logger;
        private readonly Record _record;

        public cursorsModel(ILogger<cursorsModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
