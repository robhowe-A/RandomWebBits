...
{
    internal sealed class dictionarywordModel : PageModel
    {
        private readonly ILogger<dictionarywordModel> _logger;
        private readonly Record _record;

        public dictionarywordModel(ILogger<dictionarywordModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
