...
{
    internal sealed class domainlookupModel : PageModel
    {
        private readonly ILogger<domainlookupModel> _logger;
        private readonly Record _record;

        public domainlookupModel(ILogger<domainlookupModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
