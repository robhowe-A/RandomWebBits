...
{
    internal sealed class googleplatformModel : PageModel
    {
        private readonly ILogger<googleplatformModel> _logger;
        private readonly Record _record;

        public googleplatformModel(ILogger<googleplatformModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
