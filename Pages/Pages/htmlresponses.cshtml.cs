...
{
    internal sealed class htmlresponsesModel : PageModel
    {
        private readonly ILogger<htmlresponsesModel> _logger;
        private readonly Record _record;

        public htmlresponsesModel(ILogger<htmlresponsesModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
