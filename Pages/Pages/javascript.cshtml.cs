...
{
    internal sealed class javascriptModel : PageModel
    {
        private readonly ILogger<javascriptModel> _logger;
        private readonly Record _record;

        public javascriptModel(ILogger<javascriptModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
