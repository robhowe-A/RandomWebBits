...
{
    internal sealed class jsonobjectModel : PageModel
    {
        private readonly ILogger<jsonobjectModel> _logger;
        private readonly Record _record;

        public jsonobjectModel(ILogger<jsonobjectModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
