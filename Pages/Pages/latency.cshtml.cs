...
{
    internal sealed class latencyModel : PageModel
    {
        private readonly ILogger<latencyModel> _logger;
        private readonly Record _record;

        public latencyModel(ILogger<latencyModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
