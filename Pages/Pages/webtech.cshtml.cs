...
{
    internal sealed class webtechModel : PageModel
    {
        private readonly ILogger<webtechModel> _logger;
        private readonly Record _record;

        public webtechModel(ILogger<webtechModel> logger, Record record)
        {
            _logger = logger;
            _record = record;
        }
