...
class DictionarySearchWidget extends DictionarySearchMarkup_1.default {
    ...
    static getLocalStorageWordCaches() {
        ...
        let storageStr;
        if (RWBErrorBus_1.default.checkLocalStorageEqualNull("DictionarySearch", "word-caches")) {
...
class RWBErrorBus {
    ...
    ;
    static checkLocalStorageEqualNull(componentname, key) {
        let test;
...
class ToDoList {
    ...
    static isToDoInStorage() {
        let todos;
        if (RWBErrorBus_1.default.checkLocalStorageEqualNull("ToDoList", "ToDos")) {
            return false;
        }
