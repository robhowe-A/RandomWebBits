...
class RWBCard {
    ...
    buildRWBCardMarkup(article) {
        ...
        data_AttributionLinks_1.default.map((link) => this.buildRWBCardAttributionPanel(this.RWBElements, link));
        // The card is WebBit
