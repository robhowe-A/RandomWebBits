...
const WebBitsSlideShow = {
  init: () => {
    ...
    let numberelementtext = () => {
      if (windowsize == "SMALL") {
        numberelement.innerText =
          aaslideshow.cardcounter.toString() + " of " + aaslideshow.cards.length.toString();
      } else {
        numberelement.innerText =
          "[" +
    ...
    if (windowsize == "SMALL") {
      aaslideshow.cards[1].style.transform = "translateX(182.5px)";
      aaslideshow.cards[1].children[1].children[2].setAttribute("tabindex", "-1");
      aaslideshow.cards[1].children[1].children[3].setAttribute("tabindex", "-1");
    }
  ...
  prev: (slideshow: CardsSlideShow, windowsize: string) => {
    ...
    if (windowsize == "LARGE") {
      ...
      if (slideshow.cards[slideshow.cardindxstart - 2] != undefined) {
        ...
        slideshow.cards[slideshow.cardindxstart - 2].children[1].children[3].setAttribute("tabindex", "-1");
