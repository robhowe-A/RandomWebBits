...
(m[b] = !0),
  ...
  (null !== (u = c.reactiveElementVersions) && void 0 !== u ? u : (c.reactiveElementVersions = [])).push(
    "1.6.3"
  );
const w = window,
  _ = w.trustedTypes,
...
const ft = !1,
  ...
  bt = { HTML: 1, SVG: 2 },
  mt = (t, i) =>
    void 0 === i ? void 0 !== (null == t ? void 0 : t._$litType$) : (null == t ? void 0 : t._$litType$) === i,
  gt = t => {
    var i;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
/*window.litDisableBundleWarning||console.warn("Lit has been loaded from a bundle that combines all core features into a single file. To reduce transfer size and parsing cost, consider using the `lit` npm package directly in your project.");*/ export {
